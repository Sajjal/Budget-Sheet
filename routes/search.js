...
async function searchRecords() {
    ...
    .post('/search', async function(req, res) {
        ...
        if (req.body.category_inc === 'Select a Category...(Optional)') { category = req.body.category_exp; } else
        if (req.body.category_exp === 'Select a Category...(Optional)') { category = req.body.category_inc; }

        if (category === 'Select a Category...(Optional)') { category = null; }
        ...
        if (searchFor === null) { searchTo = null }
